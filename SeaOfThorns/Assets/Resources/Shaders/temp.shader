Shader "WX/URP/Post/scan"
{
...

  {
...

    {
      ...
      real4 depthnormal= SAMPLE_TEXTURE2D(_CameraDepthNormalsTexture,sampler_CameraDepthNormalsTexture,i.screenPosition.yw/i.screenPosition.w);

        //float4 depthnormal = tex2D(_CameraDepthNormalsTexture, i.screenPosition);
